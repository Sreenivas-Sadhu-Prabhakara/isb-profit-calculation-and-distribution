package com.bank.islamic.profitcalculationanddistribution.model;
...
/**
 * The BIAN control record for this service domain: "Profit Distribution Run Procedure".
 *
 ...
 * to its asset type (Profit Distribution Run). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Profit Distribution Run Procedure";
